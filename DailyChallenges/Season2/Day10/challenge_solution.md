...
## 📘 **Theory Answers** – File: `~/heist_vault/theory_answers.txt`
...
10. SGID (Set Group ID) effect:
    When a directory has the SGID bit set, files created within inherit the group ownership of the directory instead of the user’s default group.
```
